...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "admin.goods.add.prompt.price": "Введите цену для позиции в {currency} (например, 199 или 199.99):",
        "admin.goods.add.price.invalid": "⚠️ Некорректная цена. Введите число с не более чем двумя знаками после запятой.",
        ...
        "shop.purchase.fail.no_provider": "❌ Товар недоступен: не настроен поставщик API",
        "shop.purchase.confirm_self": "Подтвердите покупку <b>{item_name}</b> за {price} {currency}.",
        "shop.purchase.confirm_gift": "Подарок <b>{item_name}</b> ({price} {currency}) получателю <code>{recipient_id}</code>. Подтвердить?",
        "shop.purchase.processing_order": "⏳ Заказ #{order_id} обрабатывается. Мы пришлём товар, когда он будет готов.",
        "shop.purchase.gift_sent": "🎁 Подарок «{item_name}» отправлен пользователю {recipient_id} (заказ #{order_id}). Ключ получит адресат.",
        "shop.item.fulfillment_stock": "📦 Выдача: со склада (мгновенно)",
        "shop.item.fulfillment_api": "🌐 Выдача: онлайн (после обработки заказа)",
        "shop.item.gift_available": "🎁 Можно оформить в подарок",
        "shop.gift.prompt_recipient": "Введите Telegram ID получателя (число). Получатель должен быть зарегистрирован в боте.",
        "shop.gift.invalid_recipient": "❌ Укажите числовой Telegram ID получателя.",
        "shop.gift.not_allowed": "❌ Этот товар нельзя подарить",
        "shop.gift.recipient_not_registered": "❌ Получатель не найден. Он должен хотя бы раз открыть бота.",
        "shop.orders.title": "📋 Ваши заказы",
        "shop.orders.empty": "У вас пока нет заказов.",
        "shop.orders.not_found": "Заказ не найден",
        "shop.orders.list_line": "#{order_id} · {name} — {status}",
        "shop.orders.detail_title": "Заказ #{order_id}",
        "shop.orders.detail_goods": "Товар: {name}",
        "shop.orders.detail_status": "Статус: {status}",
        "shop.orders.detail_total": "Сумма: {amount} ₽",
        "shop.orders.detail_delivered": "Товар выдан — ключ доступен по кнопке ниже.",
        "shop.orders.detail_pending": "Заказ ещё обрабатывается — ключ появится после завершения.",
        "shop.orders.detail_failed": "Заказ не выполнен. Средства возвращены на баланс, если применимо.",
        "shop.orders.detail_refunded": "Заказ возвращён на баланс.",
        "shop.orders.detail_expired": "Заказ истёк без оплаты.",
        "shop.order.status.CREATED": "создан",
        "shop.order.status.PROCESSING": "в обработке",
        "shop.order.status.COMPLETED": "выполнен",
        "shop.order.status.FAILED": "ошибка",
        "shop.order.status.EXPIRED": "истёк",
        "shop.order.status.REFUNDED": "возврат",
        ...
        "admin.menu.support": "🆘 Тикеты поддержки",

        "support.intro": "Здесь вы можете создать обращение в поддержку. Текстовые сообщения; медиа в этой версии не принимаются.",
        "support.prompt.new_body": "Опишите проблему одним сообщением:",
        "support.prompt.reply": "Введите ваше сообщение для поддержки:",
        "support.prompt.order_id": "Введите номер заказа (только цифры), который относится к обращению:",
        "support.created": "✅ Обращение <b>#{id}</b> создано. Вы можете дописать сообщения или привязать заказ.",
        "support.message_sent": "Сообщение отправлено в тикет.",
        "support.closed": "Обращение #{id} закрыто.",
        "support.order_linked": "К тикету привязан заказ #{order_id}.",
        "support.invalid_order_id": "Некорректный номер заказа.",
        "support.empty_message": "Сообщение не может быть пустым.",
        "support.message_too_long": "Слишком длинное сообщение.",
        "support.active_ticket_exists": "У вас уже есть открытое обращение. Допишите в него или закройте его.",
        "support.not_found": "Обращение не найдено.",
        "support.ticket_closed": "Обращение закрыто.",
        "support.order_not_found": "Заказ не найден или не принадлежит вам.",
        "support.btn.new": "➕ Новое обращение",
        "support.btn.reply": "💬 Написать",
        "support.btn.link_order": "🔗 Привязать заказ",
        "support.btn.close": "✅ Закрыть обращение",
        "support.ticket.header": "🆘 Тикет <b>#{id}</b> · статус: <code>{status}</code> · заказ: <code>{order_id}</code>",
        "support.message.line": "<b>{role}</b> ({date}):\n{body}",
        "support.role.user": "Вы",
        "support.role.staff": "Поддержка",
        "support.staff_reply_notify": "💬 Ответ поддержки:\n{body}",

        "admin.support.list_title": "🆘 Обращения в поддержку",
        "admin.support.list_empty": "Нет обращений.",
        "admin.support.list_item": "#{id} · {status} · user {user_id}",
        "admin.support.detail": "🆘 Тикет <b>#{id}</b>\nПользователь: <code>{user_id}</code>\nСтатус: <code>{status}</code>",
        "admin.support.order_linked": "Заказ: <b>#{order_id}</b> · {order_status} · {total_cents} коп.",
        "admin.support.btn.reply": "💬 Ответить",
        "admin.support.btn.close": "Закрыть",
        "admin.support.btn.reopen": "Открыть снова",
        "admin.support.prompt.reply": "Текст ответа пользователю:",
        "admin.support.reply_sent": "Ответ сохранён и отправлен пользователю.",
        "admin.support.status_updated": "Статус обновлён.",
    ...
    "en": {
        ...
        "btn.view_delivery": "🔑 View delivery",
        "btn.yes": "✅ Yes",
        "btn.no": "❌ No",
        "btn.check": "🔄 Check",
        ...
        "admin.goods.add.prompt.price": "Enter item price in {currency} (e.g. 199 or 199.99):",
        "admin.goods.add.price.invalid": "⚠️ Invalid price. Use a number with at most 2 decimal places.",
        ...
        "shop.purchase.fail.no_provider": "❌ Item unavailable: API provider is not configured",
        "shop.purchase.confirm_self": "Confirm purchase of <b>{item_name}</b> for {price} {currency}.",
        "shop.purchase.confirm_gift": "Gift <b>{item_name}</b> ({price} {currency}) to user <code>{recipient_id}</code>. Confirm?",
        "shop.purchase.processing_order": "⏳ Order #{order_id} is processing. We will deliver when it is ready.",
        "shop.purchase.gift_sent": "🎁 Gift «{item_name}» sent to user {recipient_id} (order #{order_id}). The recipient gets the key.",
        "shop.item.fulfillment_stock": "📦 Fulfillment: from stock (instant)",
        "shop.item.fulfillment_api": "🌐 Fulfillment: online (after processing)",
        "shop.item.gift_available": "🎁 Can be sent as a gift",
        "shop.gift.prompt_recipient": "Enter the recipient's Telegram ID (number). They must have used the bot at least once.",
        "shop.gift.invalid_recipient": "❌ Enter a numeric Telegram ID.",
        "shop.gift.not_allowed": "❌ This item cannot be gifted",
        "shop.gift.recipient_not_registered": "❌ Recipient not found. They must open the bot first.",
        "shop.orders.title": "📋 Your orders",
        "shop.orders.empty": "You have no orders yet.",
        "shop.orders.not_found": "Order not found",
        "shop.orders.list_line": "#{order_id} · {name} — {status}",
        "shop.orders.detail_title": "Order #{order_id}",
        "shop.orders.detail_goods": "Item: {name}",
        "shop.orders.detail_status": "Status: {status}",
        "shop.orders.detail_total": "Total: {amount} ₽",
        "shop.orders.detail_delivered": "Delivered — use the button below for the key.",
        "shop.orders.detail_pending": "Still processing — the key appears when the order completes.",
        "shop.orders.detail_failed": "Order failed. Balance was refunded if applicable.",
        "shop.orders.detail_refunded": "Order refunded to balance.",
        "shop.orders.detail_expired": "Order expired unpaid.",
        "shop.order.status.CREATED": "created",
        "shop.order.status.PROCESSING": "processing",
        "shop.order.status.COMPLETED": "completed",
        "shop.order.status.FAILED": "failed",
        "shop.order.status.EXPIRED": "expired",
        "shop.order.status.REFUNDED": "refunded",
        ...
        "admin.menu.support": "🆘 Support tickets",

        "support.intro": "Create a support ticket here. Text only in this version (no media).",
        "support.prompt.new_body": "Describe your issue in one message:",
        "support.prompt.reply": "Type your message to support:",
        "support.prompt.order_id": "Enter the order number (digits only) for this ticket:",
        "support.created": "✅ Ticket <b>#{id}</b> created. You can add messages or link an order.",
        "support.message_sent": "Message added to the ticket.",
        "support.closed": "Ticket #{id} closed.",
        "support.order_linked": "Order #{order_id} linked to the ticket.",
        "support.invalid_order_id": "Invalid order number.",
        "support.empty_message": "Message cannot be empty.",
        "support.message_too_long": "Message is too long.",
        "support.active_ticket_exists": "You already have an open ticket. Continue it or close it first.",
        "support.not_found": "Ticket not found.",
        "support.ticket_closed": "Ticket is closed.",
        "support.order_not_found": "Order not found or does not belong to you.",
        "support.btn.new": "➕ New ticket",
        "support.btn.reply": "💬 Write",
        "support.btn.link_order": "🔗 Link order",
        "support.btn.close": "✅ Close ticket",
        "support.ticket.header": "🆘 Ticket <b>#{id}</b> · status: <code>{status}</code> · order: <code>{order_id}</code>",
        "support.message.line": "<b>{role}</b> ({date}):\n{body}",
        "support.role.user": "You",
        "support.role.staff": "Support",
        "support.staff_reply_notify": "💬 Support reply:\n{body}",

        "admin.support.list_title": "🆘 Support tickets",
        "admin.support.list_empty": "No tickets.",
        "admin.support.list_item": "#{id} · {status} · user {user_id}",
        "admin.support.detail": "🆘 Ticket <b>#{id}</b>\nUser: <code>{user_id}</code>\nStatus: <code>{status}</code>",
        "admin.support.order_linked": "Order: <b>#{order_id}</b> · {order_status} · {total_cents} kopecks",
        "admin.support.btn.reply": "💬 Reply",
        "admin.support.btn.close": "Close",
        "admin.support.btn.reopen": "Reopen",
        "admin.support.prompt.reply": "Reply text for the user:",
        "admin.support.reply_sent": "Reply saved and sent to the user.",
        "admin.support.status_updated": "Status updated.",
